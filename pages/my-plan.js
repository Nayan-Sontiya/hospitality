...
function MyPlan() {
  ...
  return (
    <>
      <Head>
        <title>
          My Plan - Guidelines for hiring and managing hospitality staff.
        </title>
        <meta
          name="title"
          content="My Plan - Guidelines for hiring and managing hospitality staff."
        />
        <meta
          name="description"
        ...
        <meta
          name="keywords"
          content="guidelines for hiring and managing hospitality staff, female hospitality staff, what is hospitality staff, general hospitality staff, how to recruit hospitality staff, how to train hospitality staff, how to find hospitality staff, how to motivate hospitality staff, hiring and managing hospitality staff,"
        />
        <meta
                    ...
                    <div className="w-80 bg-[#1b1465] p-3 rounded">
                      ...
                      <div className="grid justify-items-center">
                        ...
                        <div className="flex pt-3">
                          ...
                          <p className="text-[#ffffff]">&nbsp; {dayLeft}</p>
                        </div>
                      </div>
                    </div>
                  </div>
