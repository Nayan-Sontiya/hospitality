    ...
    return (
        <>
            ...
            <div className="px-5 sm:px-10 lg:px-16 3xl:px:20">
                ...
                <p className="">
                    Only a go-getter can survive the hectic schedule of a kitchen. A person who has a habit of wasting time or lacks motivation is not the right choice for your café. He should also be able to communicate effectively. It is this manner of communication that will remove all doubts while working. .Look for the <b>best Agency for chefs,</b> so you only get trustworthy staff.</p>
