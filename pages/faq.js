  ...
  return (
    <>
      <div>
        <Head>
          <title>
            Frequently Asked Question | Best website for hospitality staffing
            solutions
          </title>
          <meta
            name="title"
            content="Frequently Asked Question | Best website for hospitality staffing solutions"
          />
          <meta
          ...
          <meta
            name="keywords"
            content="Best website for hospitality job seekers, hospitality job recruiter, jobs in hospitality, hospitality staffing agencies near me, hospitality staffing solutions, job seekers for hospitality, hospitality staff job seeker, best hospitality staff near me, find best hospitality management website, find best hospitality staff near me, best website for hospitality jobs, housekeepers for hire near me, utility staff for hire near me, receptionists for hire near me, lobby managers for hire near me, doorman for hire near me, room attendant for hire near me, security staff for hire near me, waiters for hire near me,"
          />
          <meta
            name="description"
                      ...
                      return (
                        <details className="mb-4" key={ques.id}>
                          ...
                          <div className="px-5 md:px-8 bg-gray-300 rounded-md mt-2 py-2">
                            <span className="font-semibold text-[#1b1465]">
                              {ques.answer}
                            </span>
                          </div>
                        </details>
